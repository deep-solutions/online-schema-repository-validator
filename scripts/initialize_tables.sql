...
INSERT INTO CANONICAL_FORMATS (CDF_TYPE) VALUES ('JSON Schema');
...
-- DDL
CREATE TABLE CANONICAL_SCHEMAS (CDF_SCHEMA_ID INTEGER PRIMARY KEY AUTOINCREMENT, FOREIGN KEY (CDF_NAME) REFERENCES CANONICALS(CDF_NAME) NOT NULL, FOREIGN KEY (CDF_TYPE) REFERENCES CANONICAL_FORMATS(CDF_TYPE) NOT NULL, CDF_VERSION VARCHAR(5) DEFAULT '0.1', CDF_SCHEMA_RELATIVE_PATH VARCHAR(100) NOT NULL);

-- DML
INSERT INTO CANONICAL_SCHEMAS (CDF_NAME, CDF_TYPE, CDF_VERSION, CDF_SCHEMA_RELATIVE_PATH) VALUES ('ARTICLE', 'XSD', '1.0', 'Files/Article/V1.0/Article.xsd');
INSERT INTO CANONICAL_SCHEMAS (CDF_NAME, CDF_TYPE, CDF_VERSION, CDF_SCHEMA_RELATIVE_PATH) VALUES ('ARTICLE', 'XSD', '1.0', 'Files/Employee/V1.0/Employee.xsd');